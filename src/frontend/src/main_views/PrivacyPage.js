...
export function Privacy() {
    return <Box sx={{height: '100%', overflow:'auto', pt: 5}}>
        ...
        <p>Effective date: January 26, 2022</p>

        <p>Shareyourwiz LLC ("us", "we", or "our") operates the Shareyourwiz mobile application (hereinafter referred to as the "Service").</p>
        ...
        <ul>
            <li>
                ...
                <p>Service is the Shareyourwiz mobile application operated by Shareyourwiz LLC</p>
            </li>
            <li>
        ...
        <ul>
            <li>First name and last name</li>    <li>Email</li>        <li>Cookies and Usage Data</li>
        </ul>
        ...
        <h2>Use of Data</h2>
        <p>Shareyourwiz LLC uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>If you are from the European Economic Area (EEA), Shareyourwiz LLC legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>
        <p>Shareyourwiz LLC may process your Personal Data because:</p>
        <ul>
        ...
        <p>Shareyourwiz LLC will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes and enforce our legal agreements and policies.</p>
        <p>Shareyourwiz LLC will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer periods.</p>

        <h2>Transfer of Data</h2>
        <p>Your information, including Personal Data, may be transferred to - and maintained on - computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ from those of your jurisdiction.</p>
        <p>If you are located outside United States and choose to provide information to us, please note that we transfer the data, including Personal Data, to United States and process it there.</p>
        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
        <p>Shareyourwiz LLC will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

        <h2>Disclosure of Data</h2>
        <h3>Business Transaction</h3>
        <p>If Shareyourwiz LLC is involved in a merger, acquisition or asset sale, your Personal Data may be transferred. We will provide notice before your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>

        <h3>Disclosure for Law Enforcement</h3>
        <p>Under certain circumstances, Shareyourwiz LLC may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>

        <h3>Legal Requirements</h3>
        <p>Shareyourwiz LLC may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Shareyourwiz LLC</li>
        ...
        <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Shareyourwiz LLC aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.</p>
        ...
        <ul>
            ...
            <li>
                <p><strong>The right to withdraw consent.</strong> You also have the right to withdraw your consent at any time where Shareyourwiz LLC relied on your consent to process your personal information.</p>
            </li>
        </ul>
        ...
        <ul>
            <li>By email: info@shareyourwiz.com</li>
...
export default function PrivacyPage(props) {
    ...
    return (mobile ? <Privacy /> : <Grid container spacing={2} columns={12} sx={{ display: { xs: 'none', md: 'flex' } }}>
        <Grid item xs={3}>
        </Grid>
